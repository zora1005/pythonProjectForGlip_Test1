...
def run(ENV,userName,extNum,passWord,portID, createTeamCount,messageCount,type):
    ...
    teamName = "teamA"+str(time.time())+"_No."
...
run(os.getenv('ENV'),os.getenv('RCNumber'),os.getenv('RCExtension'),os.getenv('RCPassword'),os.getenv('SanboxPortID'),int(os.getenv('TeamCount')),int(os.getenv('MessageCountPerTeam')),os.getenv('type'))
#run('http://api-up.lab.rcch.ringcentral.com','18002491122','106','Test!123','23304',3,2, 'event')
